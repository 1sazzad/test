...
class OrderMiddleware {
	...
	validateOrderRequestCreation = (
		...
		try {
			...
			if (validationResult.error) {
				console.log(
					"Error occures while validating order request creation: "
						.red,
					validationResult.error.message,
				);
				return responseSender(res, 400, validationResult.error.message);
			...
			console.log(
				"Error occures while validating order request creation: ".red,
				err.message,
			);
			next(err);
		}
	...
	validateOrderPaymentCreation = (
		...
		try {
			...
			if (validationResult.error) {
				console.log(
					"Error occures while validating order payment creation: "
						.red,
					validationResult.error.message,
				);
				return responseSender(res, 400, validationResult.error.message);
			...
			console.log(
				"Error occures while validating order payment creation: ".red,
				err.message,
			);
			next(err);
		}
	...
	validateOrderUpdate = (req: Request, res: Response, next: NextFunction) => {
		try {
			...
			if (validationResult.error) {
				console.log(
					"Error occures while validating order update: ".red,
					validationResult.error.message,
				);
				return responseSender(res, 400, validationResult.error.message);
			}
	...
	validateOrderByCustomer = (
		...
		try {
			...
			if (validationResult.error) {
				console.log(
					"Error occures while validating order fetch by customer id: "
						.red,
					validationResult.error.message,
				);
				return responseSender(res, 400, validationResult.error.message);
