...
class CourierController {
	...
	addCourier = async (req: Request, res: Response, next: NextFunction) => {
		try {
			...
			console.log(
				"Error occured while adding courier: ".red,
				err.message,
			);
			next(err);
		}
	...
	editCourier = async (req: Request, res: Response, next: NextFunction) => {
		try {
			...
			console.log(
				"Error occured while updating courier: ".red,
				err.message,
			);
			next(err);
		}
	...
	deleteCourier = async (req: Request, res: Response, next: NextFunction) => {
		try {
			...
			console.log(
				"Error occured while creating courier: ".red,
				err.message,
			);
			next(err);
		}
	...
	getAllCourier = async (req: Request, res: Response, next: NextFunction) => {
		try {
			...
			console.log(
				"Error occured while fetching couriers: ".red,
				err.message,
			);
			next(err);
		}
