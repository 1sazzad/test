...
class ProductController {
	...
	createProductImage = async (
		...
		try {
			...
			console.log(
				"Error occured while creating product image: ".red,
				err.message,
			);
			next(err);
		}
	...
	editProduct = async (req: Request, res: Response, next: NextFunction) => {
		try {
			...
			console.log(
				"Error occured while updating product: ".red,
				err.message,
			);
			next(err);
		}
	...
	deleteProduct = async (req: Request, res: Response, next: NextFunction) => {
		try {
			...
			console.log(
				"Error occured while creating product product: ".red,
				err.message,
			);
			next(err);
		}
	...
	getProductById = async (
		...
		try {
			...
			console.log(
				"Error occured while creating product by product id: ".red,
				err.message,
			);
			next(err);
		}
	...
	getRandomProducts = async (
		...
		try {
			...
			console.log(
				"Error occured while getting random products: ".red,
				err.message,
			);
			next(err);
		}
