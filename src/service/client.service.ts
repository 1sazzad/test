...
class ClientService {
	addClient = async (
		...
		try {
			...
			console.log(
				"Error occured while creating client: ".red,
				err.message,
			);
			throw err;
		}
	...
	editClient = async (
		...
		try {
			...
			console.log(
				"Error occured while updating client: ".red,
				err.message,
			);
			throw err;
		}
	...
	getClientById = async (
		...
		try {
			...
			console.log(
				"Error occured while getting client by id: ".red,
				err.message,
			);
			throw err;
		}
	...
	deleteClient = async (clientId: number): Promise<boolean> => {
		try {
			...
			console.log(
				"Error occured while deleting client by id: ".red,
				err.message,
			);
			throw err;
		}
	...
	getAllClients = async (
		...
		try {
			...
			console.log(
				"Error occured while getting clients: ".red,
				err.message,
			);
			throw err;
		}
