...
class ProductService {
	createProduct = async (
		...
		try {
			...
			console.log(
				"Error occurred while creating product: ".red,
				err.message,
			);
			throw err;
		}
	...
	createProductImage = async (
		...
		try {
			...
			console.log(
				"Error occurred while creating product image: ".red,
				err.message,
			);
			throw err;
		}
	...
	getProductById = async (
		...
		try {
			...
			console.log(
				"Error occurred while fetching product by id: ".red,
				err.message,
			);
			throw err;
		}
	...
	getRandomProducts = async (
		...
		try {
			...
			console.log(
				"Error occurred while getting random products: ".red,
				err.message,
			);
			throw err;
		}
	...
	getProductImagesByProductId = async (
		...
		try {
			...
			console.log(
				"Error occurred while getting product images by product id: "
					.red,
				err.message,
			);
			throw err;
	...
	deleteProductImage = async (imageId: number): Promise<boolean> => {
		try {
			...
			console.log(
				"Error occured while deleting product image: ".red,
				err.message,
			);
			throw err;
		}
	...
	activeProduct = async (
		...
		try {
			...
			console.log(
				"Error occured while activating product: ".red,
				err.message,
			);
			throw err;
		}
	...
	inactiveProduct = async (
		...
		try {
			...
			console.log(
				"Error occured while inactivating product: ".red,
				err.message,
			);
			throw err;
		}
	...
	getAllProducts = async (
		...
		try {
			...
			console.log(
				"Error occurred while fetching products: ".red,
				err.message,
			);
			throw err;
		}
	...
	addProductImage = async (
		...
		try {
			...
			console.log(
				"Error occurred while adding product image: ".red,
				err.message,
			);
			throw err;
		}
	...
	removeProductImage = async (imageId: number): Promise<boolean> => {
		try {
			...
			console.log(
				"Error occurred while deleting product image: ".red,
				err.message,
			);
			throw err;
		}
